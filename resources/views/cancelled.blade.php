<x-app-layout>
    <div class="bg-white">
        <div class="mx-auto max-3xl py-8 sm:px-6 md:px-8">
            ...
            <div class="flow-root overflow-hidden bg-white shadow rounded-lg">
                ...
                <div class="bg-gray-50 border-b border-gray-200 px-4 py-5 sm:px-6">
                    <h1 class="text-xl font-bold leading-5 text-gray-900">Succesvol geannuleerd!</h1>
                </div>
                        ...
                        <div class="bg-gray-100">
                            <div class="bg-white p-6  md:mx-auto">
                              ...
                              <div class="text-center">
                                  <h3 class="md:text-2xl text-base text-gray-900 font-semibold text-center">Succesvol geannuleerd!</h3>
